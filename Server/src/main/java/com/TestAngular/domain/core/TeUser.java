package com.TestAngular.domain.core;
...
public class TeUser implements UserDetails {
	...
	*/
	...
	public TeUser(String firstName, String lastName) {
		super();
    ...
    private Set<TeAuthority>  roles = new HashSet<TeAuthority>();;
    @Column
	...
	public Set<TeAuthority> getRoles() {
		return roles;
	}

	public void setRoles(Set<TeAuthority> roles) {
		this.roles = roles;
	}
